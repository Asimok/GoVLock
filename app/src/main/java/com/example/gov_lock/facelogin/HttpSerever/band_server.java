...
public class band_server extends AppCompatActivity {

    private String EmployeeNumber, mima,BuildingNumber,RoomNumber;
    ...
    public void startband( String EmployeeNumber1, String mima1,String buildingNumber,String roomNumber) {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(band_server.this, "连接服务器失败！", Toast.LENGTH_SHORT).show();
            }
    ...
    public void insert() {
        ...
        values.put("BuildingNumber", BuildingNumber);
